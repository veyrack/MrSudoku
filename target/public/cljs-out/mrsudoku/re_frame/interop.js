...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__9442 = cljs.core.instance_QMARK_;
var expr__9443 = reactive_val;
if(cljs.core.truth_(pred__9442.call(null,reagent.ratom.RAtom,expr__9443))){
return "ra";
} else {
if(cljs.core.truth_(pred__9442.call(null,reagent.ratom.RCursor,expr__9443))){
return "rc";
} else {
if(cljs.core.truth_(pred__9442.call(null,reagent.ratom.Reaction,expr__9443))){
return "rx";
} else {
if(cljs.core.truth_(pred__9442.call(null,reagent.ratom.Track,expr__9443))){
return "tr";
} else {
return "other";
}
