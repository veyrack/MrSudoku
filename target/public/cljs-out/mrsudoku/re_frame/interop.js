...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__9221 = cljs.core.instance_QMARK_;
var expr__9222 = reactive_val;
if(cljs.core.truth_(pred__9221.call(null,reagent.ratom.RAtom,expr__9222))){
return "ra";
} else {
if(cljs.core.truth_(pred__9221.call(null,reagent.ratom.RCursor,expr__9222))){
return "rc";
} else {
if(cljs.core.truth_(pred__9221.call(null,reagent.ratom.Reaction,expr__9222))){
return "rx";
} else {
if(cljs.core.truth_(pred__9221.call(null,reagent.ratom.Track,expr__9222))){
return "tr";
} else {
return "other";
}
