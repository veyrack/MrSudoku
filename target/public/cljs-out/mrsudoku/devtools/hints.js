...
var temp__5718__auto___20586 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___20586)){
var seen_errors_20587 = temp__5718__auto___20586;
if(cljs.core.truth_(seen_errors_20587.has(self))){
} else {
seen_errors_20587.add(self);

var temp__5720__auto___20588 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___20588)){
var sense_20589 = temp__5720__auto___20588;
