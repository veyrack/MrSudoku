...
var o16116 = temp__5718__auto__;
var temp__5718__auto____$1 = (o16116["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o16117 = temp__5718__auto____$1;
return (o16117["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15046__auto__ = f;
return (o__15046__auto__["toString"]).call(o__15046__auto__);
} else {
return "";
}
}catch (e16118){var _ = e16118;
return "";
}});
...
try{var o__15046__auto___16120 = t;
(o__15046__auto___16120["cljs$lang$ctorPrWriter"]).call(o__15046__auto___16120,t,writer);
}catch (e16119){var __16121 = e16119;
}
...
var char_code = (function (){var o__15046__auto__ = (new String(char$));
return (o__15046__auto__["charCodeAt"]).call(o__15046__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15046__auto__ = String;
return (o__15046__auto__["fromCharCode"]).call(o__15046__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16122 = num_code;
switch (G__16122) {
case (1):
return (185);
...
var o__15046__auto__ = String;
return (o__15046__auto__["fromCharCode"]).call(o__15046__auto__,superscript_code);
});
/**
...
}catch (e16124){var _e__15053__auto__ = e16124;
return false;
}})())){
...
var vec__16125 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16125,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o16128 = temp__5718__auto__;
var temp__5718__auto____$1 = (o16128["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o16129 = temp__5718__auto____$1;
return (o16129["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___16136 = arguments.length;
var i__4532__auto___16137 = (0);
while(true){
if((i__4532__auto___16137 < len__4531__auto___16136)){
args__4534__auto__.push((arguments[i__4532__auto___16137]));

var G__16138 = (i__4532__auto___16137 + (1));
i__4532__auto___16137 = G__16138;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16132){
var vec__16133 = p__16132;
var ns_detector = cljs.core.nth.call(null,vec__16133,(0),null);
...
var G__16139 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16140 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16139;
remaining_tokens = G__16140;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16130){
var G__16131 = cljs.core.first.call(null,seq16130);
var seq16130__$1 = cljs.core.next.call(null,seq16130);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16131,seq16130__$1);
});
...
var vec__16144 = cljs.core.split_with.call(null,(function (p1__16143_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16143_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16144,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16144,(1),null);
...
var vec__16147 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16147,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16147,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16150 = cljs.core.rest.call(null,remaining_tokens);
var G__16151 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16150;
name_tokens = G__16151;
continue;
} else {
...
var vec__16154 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16154,(0),null);
var arity = cljs.core.nth.call(null,vec__16154,(1),null);
var vec__16157 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16157,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16157,(1),null);
var vec__16160 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16160,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16160,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16160,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16160,(3),null);
...
var vec__16166 = result;
var munged_ns = cljs.core.nth.call(null,vec__16166,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16166,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16166,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16166,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16166,(4),null);
var arity = cljs.core.nth.call(null,vec__16166,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__16170 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__16170,(0),null);
var args = cljs.core.nth.call(null,vec__16170,(1),null);
var vec__16173 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16173,(0),null);
var name = cljs.core.nth.call(null,vec__16173,(1),null);
...
var G__16176 = (arity + (1));
var G__16177 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16178){
var vec__16179 = p__16178;
var arity = cljs.core.nth.call(null,vec__16179,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16179,(1),null);
...
return cljs.core.get.call(null,arities,p1__16182_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__16183_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___16190 = arguments.length;
var i__4532__auto___16191 = (0);
while(true){
if((i__4532__auto___16191 < len__4531__auto___16190)){
args__4534__auto__.push((arguments[i__4532__auto___16191]));

var G__16192 = (i__4532__auto___16191 + (1));
i__4532__auto___16191 = G__16192;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16186){
var vec__16187 = p__16186;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16187,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16184){
...
var G__16193 = arg;
var G__16193__$1 = (((G__16193 instanceof cljs.core.Keyword))?G__16193.fqn:null);
switch (G__16193__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__16195__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16195__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16195__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16195__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16196 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16196,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16196,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16196,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16196,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16196,(4),null);
var arity = cljs.core.nth.call(null,vec__16196,(5),null);
...
var o__15046__auto__ = f;
return (o__15046__auto__["getBasis"]).call(o__15046__auto__);
});
/**
...
}catch (e16200){var _e__15053__auto__ = e16200;
...
var G__16201 = (obj[cljs.core.first.call(null,path)]);
var G__16202 = cljs.core.rest.call(null,path);
obj = G__16201;
path = G__16202;
continue;
} else {
...
return (function (accum,p__16203){
var vec__16204 = p__16203;
var bit = cljs.core.nth.call(null,vec__16204,(0),null);
var protocol = cljs.core.nth.call(null,vec__16204,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16207){
var vec__16208 = p__16207;
var ns = cljs.core.nth.call(null,vec__16208,(0),null);
var name = cljs.core.nth.call(null,vec__16208,(1),null);
var selector = cljs.core.nth.call(null,vec__16208,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__16213,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16213,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__16213,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__16211_SHARP_){
return (obj[cljs.core.first.call(null,p1__16211_SHARP_)]);
});})(name,sorted_matches,vec__16213,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
