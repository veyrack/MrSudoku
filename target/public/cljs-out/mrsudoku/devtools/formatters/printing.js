...
var len__4531__auto___13468 = arguments.length;
var i__4532__auto___13469 = (0);
while(true){
if((i__4532__auto___13469 < len__4531__auto___13468)){
args__4534__auto__.push((arguments[i__4532__auto___13469]));

var G__13470 = (i__4532__auto___13469 + (1));
i__4532__auto___13469 = G__13470;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13465){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13466,G__13467,seq13465__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13471_SHARP_){
return !((cljs.core.meta.call(null,p1__13471_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__13472__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13476){var _e__12454__auto__ = e13476;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e13478){var _e__12454__auto__ = e13478;
return false;
}}
})())){
...
var _STAR_current_state_STAR_13480 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__13481 = opts;
...
var markup_db = cljs.core.get.call(null,map__13481__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_13480;
}});
...
;
var temp__5718__auto___13485 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___13485)){
var managed_print_level_13486 = temp__5718__auto___13485;
var _STAR_print_level_STAR_13484_13487 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_13486;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_13484_13487,managed_print_level_13486,temp__5718__auto___13485,writer,opts,job_fn){
return (function (p1__13483_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__13483_SHARP_,null);
});})(_STAR_print_level_STAR_13484_13487,managed_print_level_13486,temp__5718__auto___13485,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_13484_13487;
}} else {
job_fn.call(null);
}
