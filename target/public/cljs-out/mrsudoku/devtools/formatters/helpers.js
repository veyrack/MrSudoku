...
var G__13439 = devtools.prefs.pref.call(null,v);
v = G__13439;
continue;
} else {
return v;
...
}catch (e13442){var _e__12454__auto__ = e13442;
return false;
}})();
...
}catch (e13446){var _e__12454__auto__ = e13446;
return false;
}})();
...
}catch (e13448){var _e__12454__auto__ = e13448;
return false;
}}
}
});
...
var vec__13450 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13450,(0),null);
var name = cljs.core.nth.call(null,vec__13450,(1),null);
...
return cljs.core.some.call(null,(function (p1__13453_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13453_SHARP_);
}),template);
});
