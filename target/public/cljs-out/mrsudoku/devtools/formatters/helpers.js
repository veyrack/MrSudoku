...
var G__16236 = devtools.prefs.pref.call(null,v);
v = G__16236;
continue;
} else {
return v;
...
}catch (e16239){var _e__15053__auto__ = e16239;
return false;
}})();
...
}catch (e16243){var _e__15053__auto__ = e16243;
return false;
}})();
...
}catch (e16245){var _e__15053__auto__ = e16245;
return false;
}}
}
});
...
var vec__16247 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16247,(0),null);
var name = cljs.core.nth.call(null,vec__16247,(1),null);
...
return cljs.core.some.call(null,(function (p1__16250_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16250_SHARP_);
}),template);
});
